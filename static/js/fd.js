...
function registerr(event) {
  ...
  if (selected == 0) {
    ...
    if (
      document.getElementById("radarname").value != "" &&
      document.getElementById("radarname").value.indexOf(" ") == -1
    ) {
...
$(document).ready(function () {
  $("#radarcanvas").click(function (evt) {
    console.log("hi");
    registerr(evt);
  });
});
  ...
  for (var key in json) {
    if (json.hasOwnProperty(key)) {
      document.getElementById("radarcanvas").innerHTML +=
        "<circle id='" +
        key +
        "' onclick='selectit(event,\"" +
        key +
        "\")' cx='" +
        json[key].x +
        "' cy='" +
        json[key].y +
        "' r='5' stroke='green' fill='green' />";
...
function addship() {
  ...
  newjson[document.getElementById("addship").value] = {
    x: document.getElementById("shipx").value,
    y: document.getElementById("shipy").value,
    z: document.getElementById("shipz").value,
    info: document.getElementById("shipinfo").value,
    shields: document.getElementById("shipshields").value,
    hull: document.getElementById("shiphull").value,
    engines: document.getElementById("shipengines").value,
    systems: document.getElementById("shipsystems").value,
  };
...
function doships(json) {
  ...
  for (var key in json) {
    if (json.hasOwnProperty(key)) {
      document.getElementById("radarlist").innerHTML +=
        "<span onclick='removeship(\"" +
        key +
        "\")'>" +
        key +
        ":</span><input type='text' value='" +
        json[key].x +
        "' style='width:30px' onchange='changeship(this,\"" +
        key +
        ...
        "' style='width:30px' onchange='changeship(this,\"" +
        key +
        "\",\"shields\")' /><input type='text' value='" +
        json[key].hull +
        "' style='width:30px' onchange='changeship(this,\"" +
        key +
        "\",\"hull\")' /><input type='text' value='" +
        json[key].engines +
        "' style='width:30px' onchange='changeship(this,\"" +
        key +
        "\",\"engines\")' /><input type='text' value='" +
        json[key].systems +
        "' style='width:30px' onchange='changeship(this,\"" +
        key +
        '","systems")\' />' +
...
function domaps(json) {
  ...
  for (var key in json) {
    if (json.hasOwnProperty(key)) {
      document.getElementById("maplist").innerHTML +=
        "<span onclick='removemap(\"" +
        key +
        "\")'>" +
        key +
        ":</span><input type='text' value='" +
        json[key].x +
        "' style='width:30px' onchange='changemap(this,\"" +
        key +
        "\",\"x\")' /><input type='text' value='" +
        json[key].y +
        "' style='width:30px' onchange='changemap(this,\"" +
  ...
  for (var key in json) {
    if (json.hasOwnProperty(key)) {
      ...
      document.getElementById("objectlist").innerHTML +=
        ...
        ":</span><input type='text' value='" +
        json[key].place +
        "' onchange='changeobject(this,\"" +
        key +
        '","place")\' /><span style=\'background-color:' +
        bg +
        ";' onmousedown='changecheck(this,\"" +
        key +
        '","lockable")\'>Lockable</span><br />';
    }
  }
}
function addobject() {
  ...
  newjson[document.getElementById("addobject").value] = {
    place: document.getElementById("objectplace").value,
    lockable: document.getElementById("objectlock").checked,
  };
...
function addsystem() {
  ...
  newjson[document.getElementById("addsystem").value] = {
    heat: parseInt(document.getElementById("systemheat").value),
    damage: parseInt(document.getElementById("systemdamage").value),
    power: parseInt(document.getElementById("systempower").value),
  };
...
function dosystems(json) {
  ...
  for (var key in json) {
    if (json.hasOwnProperty(key)) {
      document.getElementById("systemlist").innerHTML +=
        "<span onclick='removesystem(\"" +
        key +
        "\")'>" +
        key +
        ":</span><input type='text' value='" +
        json[key].heat +
        "' style='width:30px' onchange='changesystem(this,\"" +
        key +
        "\",\"heat\")' /><input type='text' value='" +
        json[key].damage +
        "' style='width:30px' onchange='changesystem(this,\"" +
        key +
        "\",\"damage\")' /><input type='text' value='" +
        json[key].power +
        "' style='width:30px' onchange='changesystem(this,\"" +
        key +
        '","power")\' /><br />';
  ...
  for (var key in json) {
    if (json.hasOwnProperty(key)) {
      ...
      if (key == "forwardthruster") {
        if (json[key] == true) {
          document.getElementById("forwardthruster").style["background-color"] =
            "#00FF00";
        } else {
          document.getElementById("forwardthruster").style["background-color"] =
            "transparent";
      ...
      if (key == "backwardthruster") {
        if (json[key] == true) {
          document.getElementById("backwardthruster").style[
            "background-color"
          ] = "#00FF00";
        } else {
          document.getElementById("backwardthruster").style[
      ...
      if (key == "leftthruster") {
        if (json[key] == true) {
          document.getElementById("leftthruster").style["background-color"] =
            "#00FF00";
        } else {
          document.getElementById("leftthruster").style["background-color"] =
            "transparent";
      ...
      if (key == "rightthruster") {
        if (json[key] == true) {
          document.getElementById("rightthruster").style["background-color"] =
            "#00FF00";
        } else {
          document.getElementById("rightthruster").style["background-color"] =
            "transparent";
      ...
      if (key == "upthruster") {
        if (json[key] == true) {
          document.getElementById("upthruster").style["background-color"] =
            "#00FF00";
        } else {
          document.getElementById("upthruster").style["background-color"] =
            "transparent";
      ...
      if (key == "downthruster") {
        if (json[key] == true) {
          document.getElementById("downthruster").style["background-color"] =
            "#00FF00";
        } else {
          document.getElementById("downthruster").style["background-color"] =
            "transparent";
