  ...
  for (var key in data["maps"]) {
    if (data["maps"].hasOwnProperty(key)) {
      if (key.indexOf(document.getElementById("mapsearch").value) > -1) {
        document.getElementById("results").innerHTML +=
          '<a class="list-group-item" onclick=\'showsearchinfo(this,"' +
          key +
          "\");buttonsound();'>" +
          key +
          "</a>";
...
function showsearchinfo(obj, json) {
  for (i = 0; i < document.getElementById("results").children.length; i++) {
    ...
    document.getElementById("results").children[i].className =
      "list-group-item";
  }
...
function update(json) {
  for (var key in json) {
    if (json.hasOwnProperty(key)) {
      ...
      if (key == "impulse") {
        if (json[key] == "0") {
          document.getElementById("impulse0button").style["box-shadow"] =
            "0 0 30px #CCCCCC";
          document.getElementById("impulsehalfbutton").style["box-shadow"] =
            "none";
          document.getElementById("impulsefullbutton").style["box-shadow"] =
            "none";
        }
        if (json[key] == "0.5") {
          document.getElementById("impulse0button").style["box-shadow"] =
      ...
      if (key == "warp") {
        if (json[key] == "0") {
          document.getElementById("warp0button").style["box-shadow"] =
            "0 0 30px #CCCCCC";
        ...
        if (json[key] == "1") {
          ...
          document.getElementById("warp1button").style["box-shadow"] =
            "0 0 30px #00FF00";
          document.getElementById("warp2button").style["box-shadow"] = "none";
          document.getElementById("warp3button").style["box-shadow"] = "none";
          document.getElementById("warp4button").style["box-shadow"] = "none";
        ...
        if (json[key] == "2") {
          document.getElementById("warp0button").style["box-shadow"] = "none";
          document.getElementById("warp1button").style["box-shadow"] = "none";
          document.getElementById("warp2button").style["box-shadow"] =
            "0 0 30px #00FF00";
          document.getElementById("warp3button").style["box-shadow"] = "none";
          document.getElementById("warp4button").style["box-shadow"] = "none";
          document.getElementById("warp5button").style["box-shadow"] = "none";
        ...
        if (json[key] == "3") {
          ...
          document.getElementById("warp1button").style["box-shadow"] = "none";
          document.getElementById("warp2button").style["box-shadow"] = "none";
          document.getElementById("warp3button").style["box-shadow"] =
            "0 0 30px #00FF00";
          document.getElementById("warp4button").style["box-shadow"] = "none";
          document.getElementById("warp5button").style["box-shadow"] = "none";
          document.getElementById("warp6button").style["box-shadow"] = "none";
        ...
        if (json[key] == "4") {
          ...
          document.getElementById("warp2button").style["box-shadow"] = "none";
          document.getElementById("warp3button").style["box-shadow"] = "none";
          document.getElementById("warp4button").style["box-shadow"] =
            "0 0 30px #0000FF";
          document.getElementById("warp5button").style["box-shadow"] = "none";
          document.getElementById("warp6button").style["box-shadow"] = "none";
          document.getElementById("warp7button").style["box-shadow"] = "none";
        ...
        if (json[key] == "5") {
          ...
          document.getElementById("warp3button").style["box-shadow"] = "none";
          document.getElementById("warp4button").style["box-shadow"] = "none";
          document.getElementById("warp5button").style["box-shadow"] =
            "0 0 30px #0000FF";
          document.getElementById("warp6button").style["box-shadow"] = "none";
          document.getElementById("warp7button").style["box-shadow"] = "none";
          document.getElementById("warp8button").style["box-shadow"] = "none";
        ...
        if (json[key] == "6") {
          ...
          document.getElementById("warp4button").style["box-shadow"] = "none";
          document.getElementById("warp5button").style["box-shadow"] = "none";
          document.getElementById("warp6button").style["box-shadow"] =
            "0 0 30px #0000FF";
          document.getElementById("warp7button").style["box-shadow"] = "none";
          document.getElementById("warp8button").style["box-shadow"] = "none";
          document.getElementById("warp9button").style["box-shadow"] = "none";
        ...
        if (json[key] == "7") {
          ...
          document.getElementById("warp5button").style["box-shadow"] = "none";
          document.getElementById("warp6button").style["box-shadow"] = "none";
          document.getElementById("warp7button").style["box-shadow"] =
            "0 0 30px #FFFF00";
          document.getElementById("warp8button").style["box-shadow"] = "none";
          document.getElementById("warp9button").style["box-shadow"] = "none";
          document.getElementById("warp99button").style["box-shadow"] = "none";
        ...
        if (json[key] == "8") {
          ...
          document.getElementById("warp6button").style["box-shadow"] = "none";
          document.getElementById("warp7button").style["box-shadow"] = "none";
          document.getElementById("warp8button").style["box-shadow"] =
            "0 0 30px #FFFF00";
          document.getElementById("warp9button").style["box-shadow"] = "none";
          document.getElementById("warp99button").style["box-shadow"] = "none";
        }
        if (json[key] == "9") {
          ...
          document.getElementById("warp7button").style["box-shadow"] = "none";
          document.getElementById("warp8button").style["box-shadow"] = "none";
          document.getElementById("warp9button").style["box-shadow"] =
            "0 0 30px #FF0000";
          document.getElementById("warp99button").style["box-shadow"] = "none";
        }
        if (json[key] == "9.9") {
          ...
          document.getElementById("warp8button").style["box-shadow"] = "none";
          document.getElementById("warp9button").style["box-shadow"] = "none";
          document.getElementById("warp99button").style["box-shadow"] =
            "0 0 30px #FF0000";
        }
      }
    }
